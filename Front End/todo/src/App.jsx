...
function App() {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://todo-app-django-react-1.onrender.com/todos")
      .then((res) => {
        setTodos(res.data);
      })
  ...
  const addTodo = async (data) => {
    ...
    try {
      const res = await axios.post(
        "https://todo-app-django-react-1.onrender.com/todos",
        data
      );
  ...
  const delTodo = async (id) => {
    ...
    try {
      await axios.delete(
        `https://todo-app-django-react-1.onrender.com/todos/${id}`
      );
